...
let evenNumbers = mixedNumbers.filter(function(e, i, arr){return num % 2 === 0;});
...
let postTaxPrices // = prices.map(function(e, i, arr){for (var i = 0; i < arr.length; i++){var tax = []; tax.push(arr[i]*.07+arr[i]}}));
